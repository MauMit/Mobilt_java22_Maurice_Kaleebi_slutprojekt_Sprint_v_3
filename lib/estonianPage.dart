...
class EstonianPage extends StatefulWidget {
  @override
  State<EstonianPage> createState() => _EstonianPageState();
}

class _EstonianPageState extends State<EstonianPage> {
  GoogleTranslator translator = GoogleTranslator();
  TextEditingController textController = TextEditingController();
  String translatedText = '';

  //creating instance of Google translator from translator package
  // creating instance of TextEditingController to mangage textfield input
  //creating an empty string called translatedText where I put the translated text

  void translate() {
    String inputText = textController.text;
    translator.translate(inputText, to: "et").then((output) {
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Estonian Page'),
        centerTitle: true,
...
//Adding my textfield for input and text to display the translated words and a button
//Also adding a navigator button to go home